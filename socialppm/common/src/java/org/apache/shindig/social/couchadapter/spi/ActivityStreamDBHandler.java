 ...
 */
@Singleton
public class ActivityStreamDBHandler implements ActivityService, PersonService, AppDataService,
   ...
   */
  @Inject
  public ActivityStreamDBHandler(@Named("shindig.canonical.json.db")
  ...
  public Future<RestfulCollection<Person>> getPeople(Set<UserId> userIds, GroupId groupId,
    ...
    try {
    	System.out.println("******* In GetPeople ********");
