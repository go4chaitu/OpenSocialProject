...
public class ExportJsProcessorTest {
  ...
  public void setUp() throws Exception {
    ...
    FeatureBundle bundle = mockExportJsBundle(resource);
  ...
  private LookupResult mockLookupResult(FeatureBundle featureBundle) {
  ...
  private FeatureBundle mockExportJsBundle(FeatureResource featureResourceMock) {
    FeatureBundle featureBundle = createMock(FeatureBundle.class);
