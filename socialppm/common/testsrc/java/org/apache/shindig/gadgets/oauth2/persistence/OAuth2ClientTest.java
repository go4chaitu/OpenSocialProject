...
public class OAuth2ClientTest extends MockUtils {
  ...
  public void testEquals_1() throws Exception {
    ...
    obj.setType( OAuth2Accessor.Type.CONFIDENTIAL);
  ...
  public void testGetType_1() throws Exception {
    final OAuth2Accessor.Type result = OAuth2ClientTest.client1
        .getType();
  ...
  public void testHashCode_3() throws Exception {
    ...
    fixture.setType( OAuth2Accessor.Type.CONFIDENTIAL);
  ...
  public void testSetType_1() throws Exception {
    ...
    fixture.setClientSecret(new byte[] {});
    fixture.setClientId("");
    final OAuth2Accessor.Type type = OAuth2Accessor.Type.CONFIDENTIAL;
