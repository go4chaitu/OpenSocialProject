...
public class ProxyServletTest extends ServletTestFixture {
  ...
  private final ProxyUri proxyUri = mock(ProxyUri.class);
  ...
  public void testDoGetWithOAuth2() throws Exception {
    ...
    ProxyUri proxyUri = new ProxyUri(-1, false, true, "default", "http://example.org/gadget.xml", REQUEST_URL);
    ...
    ProxyUri pUri = new ProxyUri(-1, false, true, "default", "http://example.org/gadget.xml", REQUEST_URL);
